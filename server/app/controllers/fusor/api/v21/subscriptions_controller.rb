...
module Fusor
  class Api::V21::SubscriptionsController < Api::V21::BaseController
    ...
    param :deployment_id, :identifier, desc: 'filter by the ID of the deployment '
    ...
    api :GET, '/subscriptions', 'Gets a list of subscription objects'
    param :id, :identifier, desc: 'ID of the subscription'
    def show
    ...
    param :manifest_file, Hash, desc: 'ID of the subscription' do
      ...
      param :deployment_id, :identifier, required: true, desc: 'ID of the deployment'
    end
    def upload
