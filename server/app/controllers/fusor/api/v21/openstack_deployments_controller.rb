...
module Fusor
  class Api::V21::OpenstackDeploymentsController < Api::V21::BaseController
    ...
    def_param_group :openstack_deployment do
      ...
      param :undercloud_ssh_password, String, desc: 'Pasword to SSH into the undercloud'
      ...
      param :undercloud_hostname, String, desc: 'Undercloud hostname'
      param :overcloud_hostname, String, desc: 'Overcloud hostname'
    ...
    param :deployment_id, :identifier, desc: 'ID of the deployment the OpenStack deployments are associated with'
    def index
    ...
    param :id, :identifier, required: true, desc: 'ID of the OpenStack deployment'
    def show
