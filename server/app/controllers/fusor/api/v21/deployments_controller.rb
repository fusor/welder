  ...
  class Api::V21::DeploymentsController < Api::V21::BaseController
    ...
    def_param_group :deployment do
      param :deployment, Hash, desc: 'QCI Deployment', required: true do
        ...
        param :foreman_task_uuid, String, desc: 'Foreman Task identifier for the main deployment task'
        ...
        param :organization_id, :identifier, 'ID of the Organization the deployment should use'
        param :lifecycle_environment_id, :identifier, 'ID of the lifecycle environment the deployment should use'
        ...
        param :rhev_engine_host_id, :identifier, desc: 'ID of the host where the RHV engine will be deployed'
        param :discovered_host_id, :identifier, desc: 'ID of the host where the RHV engine will be deployed'

        param :rhev_root_password, String, desc: 'RHV hosts root passwords'
        param :rhev_engine_admin_password, String, desc: 'RHV management engine password'
        ...
        param :rhev_share_path, String, desc: 'RHV data storage path'
        ...
        param :openstack_deployment_id, :identifier, desc: 'ID of the openstack deployment object with OpenStack fields'
    ...
    param :id, :identifier, desc: 'ID of the deployment'
    def show
      render :json => @deployment, :serializer => Fusor::DeploymentSerializer
    end

    api :PUT, '/deployments', 'Update a deployment'
    param :id, :identifier, desc: 'ID of the deployment'
    param_group :deployment
    def update
    ...
    api :PUT, '/deployments/:id/deploy', 'Begin a deployment'
    param :id, :identifier, desc: 'ID of the deployment'
    def deploy
      begin
    ...
    param :id, :identifier, required: true, desc: 'ID of the deployment'
    def redeploy
      begin
        if @deployment.invalid?
          raise ::ActiveRecord::RecordInvalid.new @deployment
    ...
    param :id, :identifier, required: true, desc: 'ID of the deployment'
    param :cdn_url, :identifier, desc: 'URL of the CDN the deployment will use'
    def validate_cdn
      begin
    ...
    api :GET, '/deployments/:id/check_mount_point', 'Get a list of compatible CPU families for all selected RHV hypervisor hosts for a deployment'
    param :id, :identifier, required: true, desc: 'ID of the deployment'
