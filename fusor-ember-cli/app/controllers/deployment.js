...
export default Ember.Controller.extend(DeploymentControllerMixin, DisableTabMixin, {
  ...
  validCloudforms: Ember.computed.alias("controllers.openstack.validCloudforms"),
  ...
  }.property("satelliteInvalid", 'isRhev', 'isOpenStack', 'isCloudForms', 'validRhev', 'validOpenStack', 'validCloudforms'),
